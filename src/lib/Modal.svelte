...
<div
	class="w-full sm:max-w-[480px] h-full border-2 border-black bg-white rounded-2xl cursor-auto px-2 sm:p-2 pb-12 pt-12"
>
	<div class="h-full w-full overflow-auto flex flex-col sm:justify-center items-center">
